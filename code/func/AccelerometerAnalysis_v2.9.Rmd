...
ProjectDir<-"~/LSS/vosslabhpc/Projects/BikeExtend/3-Experiment/2-Data/BIDS/"

# where the output folders will go
ProjectDerivDir<-"derivatives/GGIR_2.9/"
...
subdirs <- directories[grepl("sub-2*", directories)]
```
...
GGIRfiles <- GGIRfiles[!grepl("*sub-2100*",GGIRfiles)] # note this caused skip of 2102, 2103, 2105, 2106
GGIRfiles <- GGIRfiles[!grepl("*sub-2385*",GGIRfiles)]
